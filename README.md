...
ThinkForge is a modern adaptive learning platform that connects students with expert mentors through personalized, AI-driven courses. Built with React, TypeScript, and Lovable Cloud.
...
The app uses a semantic design token system defined in `src/index.css`:
